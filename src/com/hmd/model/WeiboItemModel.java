...
public class WeiboItemModel implements Parcelable {
	 ...
	 *            一条微博
	 */
	public WeiboItemModel(Status status) {
	 ...
	 *            the time
	 */
	public WeiboItemModel(String statusid, String userid, String username, String gender, String profileImageUrl,
	...
	/** Parcelable 对象的产生器 */
	public static final Parcelable.Creator<WeiboItemModel> CREATOR = new Parcelable.Creator<WeiboItemModel>() {
		 ...
		 */
		public WeiboItemModel createFromParcel(Parcel source) {
			return new WeiboItemModel(source.readString(), source.readString(), source.readString(), source.readString(),
					source.readString(), source.readString(), source.readString(), source.readString(),
					source.readString(), source.readString(), source.readString(), source.readString(),
					source.readString());
		}

		public WeiboItemModel[] newArray(int size) {
			return null;
		}
