...
public class SchoolFeedbackIntroductionActivity extends AbsSubActivity implements OnClickListener {
	...
	private String getInstroduction(){
		return "          首都师范大学教育基金会欢迎所有热心教育的有识之士以不同方式支持首都师范大学和教育事业，包括设立永久性基金，或以现金、支票、汇票、股票、证券、债券、图书，资料，设备，房产，遗产，财产等形式捐赠。"
				+ "\n\n          捐款可以指定项目和用途， 具体捐赠途径如下："
				+ "\n\n(一)银行转账 人民币捐赠账户 "
				+ "\n    开户行帐号： 0200 0076 0904 7652 806 "
				+ "\n    开户名称： 首都师范大学教育基金会 开户地址： 中国工商银行北京紫竹院支行 "
				+ "\n\n(二)邮局汇款 地 址：北京市海淀区西三环北路105号首都师范大学 "
				+ "\n    邮政编码：100048 "
